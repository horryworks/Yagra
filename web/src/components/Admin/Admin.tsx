// Admin pane: manage the node inventory and encrypted credentials (Workstream D).
// Mutations go through the typed API client; the pane re-fetches after each change.
// In skeleton mode the API returns 503 (admin_unavailable) and the pane shows a hint.
