...
> Status: **v0.1.11.** A functional stack (ICMP / SNMP v2c+v3 / URL monitoring / Cisco Meraki via
...
> collect per-interface metrics via a GETBULK table walk. HA stores remain a configuration step
> away, not a rewrite.
