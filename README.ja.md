...
> ステータス: **v0.3.32 — フォルダの削除は配下をすべて消す、インベントリ全体やフォルダ 1 つを IP レンジで並べ直せる、インベントリツリーの絞り込みを 1 つのボタンにまとめる、ディスカバリーは /20 を 1 回でスキャンする、NetBox の今すぐ同期と AI の原因説明はタブを閉じても最後まで走る、Meraki 連携の不具合を 22 件直す**
