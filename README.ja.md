...
> ステータス: **v0.1.6。** ICMP / SNMP v2c+v3 / URL 監視 / Cisco Meraki（読み取り専用 Dashboard
...
> （オプトイン）を送出し、エンドツーエンドの自己監視が可能です。WebUI は **英語と日本語**を
> その場で切り替えられるようになり、**SNMPv3** ノードは GETBULK テーブルウォークでインタフェース
