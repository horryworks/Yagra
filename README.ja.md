...
> ステータス: **v0.3.15 — どの一覧でも列の幅を自分で決められて幅はアカウントについて回り、Interfaces は受信と送信を別の列に分けて混み具合で塗り、Geo map は本物の海岸線データから描かれる**
...
> ノードをまたいで最大 6 本のインターフェースを 1 枚のグラフに描き、受信を線の上、送信を下に置きます。
