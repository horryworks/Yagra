...
> ステータス: **v0.3.26 — 光レベルのしきい値ルールが発報する、細工した SNMP inform でトラップ受信が止まらない、フォルダを限定したアカウントが担当外のノードを変えられない、可変長フィールドを含む IPFIX のレコードが記録される、履歴の保存期間より長く開いたアラートが再起動後も戻る、落ちた受信タスクが戻る**
