...
> ステータス: **v0.3.24 — 絞り込み・並び順・インベントリの検索語がリロードしても残る、インベントリのツリーで閉じたフォルダが閉じたままアカウントに保存される、CloudEngine S5735-L のスタックが全メンバーのシリアルを出す、ポップオーバーを Escape で閉じても選んだノードが外れない**
