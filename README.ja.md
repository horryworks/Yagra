...
> [!IMPORTANT]
> **v0.2.0 は Yagra の最初の公開リリースです。** また、**Yagra はオープンベータです。** 現在も活発に
...
> ステータス: **v0.2.0 — 最初の公開リリース。** ICMP / SNMP v2c+v3 / URL 監視 / DNS 監視 / Cisco Meraki（読み取り専用 Dashboard
