...
ls -l "$OUT/yagra-core" "$OUT/yagra-poller" "$OUT/docker-compose.deploy.yml" "$OUT/docker-compose.poller.yml" "$OUT/yagra-backup.sh" "$OUT/yagra-relocate.sh" "$OUT/RELOCATION-README.md" "$OUT/nats-server.conf"
