...
use yagra_common::{
    ...
    METRIC_SNMP_WALK_COMPLETE, METRIC_SSL_CERT_DAYS_TO_EXPIRY, OID_DOT3_DUPLEX_STATUS,
    OID_HW_ETHERNET_DUPLEX, OID_HW_ETHERNET_PORT_TYPE, OID_IF_HIGH_SPEED, OID_IF_TYPE,
};
use yagra_transport::{
