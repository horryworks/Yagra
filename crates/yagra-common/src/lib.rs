...
pub use collection::{
    ...
    table_rows_are_interfaces, BuiltinProfile, BuiltinTemplate, CollectionItem, CollectionKind,
    InterfaceField, OpticalFlavor, ScopedCollectionItem, METRIC_CISCO_TEMP_C,
