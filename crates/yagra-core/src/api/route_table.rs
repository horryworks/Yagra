...
pub(crate) const ROUTES: &[(&str, &str, Scoping)] = &[
    ...
    ("GET", "/api/v1/analysis/schedules", PostFiltered),
    ("POST", "/api/v1/analysis/schedules", NodeScoped),
    ("PUT", "/api/v1/analysis/schedules/:id", NodeScoped),
    ("DELETE", "/api/v1/analysis/schedules/:id", NodeScoped),
    ...
    ("GET", "/api/v1/nodes/:node_id/neighbors", NodeScoped),
    (
        "GET",
    ...
    ("PUT", "/api/v1/settings/neighbors", ADMIN_CFG),
